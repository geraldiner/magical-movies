...
const SignUp = () => {
  const SIGNUP_URI = process.env.NODE_ENV !== 'production' ? 'http://localhost:8888/signup' : 'https://wheresthemagic.herokuapp.com/signup'
    ...
    <div className="min-h-screen flex justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          />
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign up today</h2>
        ...
        <form className="mt-8 space-y-6" action={SIGNUP_URI} method="POST">
